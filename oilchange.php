                    ...
                    <div class="col-14 col-md-18 col-lg-10 col-xl-10">
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="container-fluid">Tools Required for Oil:
                                    <br>Wrench to remove drain plug (box end or socket)</br>
                                    <br>Oil filter wrench</br>
                                    <br>Oil drain pan</br>
                                    <br>Funnel</br>
                                    <br>Latex gloves</br>
                                ...
                                <div class="row">
                                    <div class="col-md-4"><img class="img-responsive" src="images/tools.jpg">
                                    </div>
                                    <div class="col-md-8">Jack and jack stands or ramps (optional, depends on ground clearance)s.</div>
                                </div>
                                
                                <a href="oilchange1.php" class="btn btn-primary">Next &raquo;</a>
