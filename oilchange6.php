                    ...
                    <div class="col-14 col-md-18 col-lg-10 col-xl-10">
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="container-fluid">
                                Finally, after waiting a few minutes for the oil to settle into the pan, use the dipstick to verify that your oil is at the proper level. Checking your oil is simple: Pull the dipstick from its tube, wipe away all oil with a paper towel, reinsert the dipstick, remove the dipstick, and confirm that the oil is lined up with the full marking on the tip of the dipstick. Finally, start the vehicle and let it idle and warm up; check for leaks under the vehicle and around the oil filter.</div>
                                <div class="row">
                                    <div class="col-md-4"><img class="img-responsive" src="images/lvlcheck.jpeg">
                                    </div>
                                    <div class="col-md-8">.</div>
                                </div>
                                <a href="oilchange5.php" class="btn btn-primary">&laquo; Previous</a>
                                <a href="oilchange7.php" class="btn btn-primary">Next &raquo;</a>
