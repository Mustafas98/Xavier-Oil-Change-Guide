                    ...
                    <div class="col-14 col-md-18 col-lg-10 col-xl-10">
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-4"><img class="img-responsive" src="images/filling.jpg">
                                    </div>
                                    <div class="col-md-8">.</div>
                                </div>
                                <a href="oilchange4.php" class="btn btn-primary">&laquo; Previous</a>
                                <a href="oilchange6.php" class="btn btn-primary">Next &raquo;</a>
